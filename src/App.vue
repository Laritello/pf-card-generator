  ...
  export default {
    ...
    computed: {
      filteredSpells() {
        ...
        console.log('filter', name, cardType, components, levels);
        return this.allSpells.filter(spell => filterSpells(spell, name, cardType, components, levels));
      }
    },

    // mounted() {
    //   this.activeCardType = { text: "Арканное", value: "arcane" };
    // },
    components: { Display }
}
</script>
